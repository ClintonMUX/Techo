...
public class Login extends javax.swing.JFrame {
   zzz conecta = new zzz();
    ...
    private void initComponents() {
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 330, 140, 30));
        ...
        jPanel2.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 330, 140, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      ARegistrtion reg = new ARegistrtion();
      reg.setVisible(true);
      dispose();
   ...
   public void login() {
        conecta.conexao();
        try {
            conecta.executaSQL("SELECT * FROM main.user WHERE username='" + combo_user.getSelectedItem() + "'");
            conecta.rs.first();
            if (conecta.rs.getString("password").equals(txt_pass.getText())) {
                int pa = conecta.rs.getInt("user_id");
                System.out.println(pa);
                conecta.executaSQL("SELECT * FROM main.tech_auth WHERE user_id='" + pa + "'");
                if(conecta.rs.first())
                  {
                     AddTech tech = new AddTech();
